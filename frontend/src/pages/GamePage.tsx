...
const GamePage: React.FC = () => {
  ...
  return (
    <>
      ...
      {hasReviewedBoard && history.length > 0 && (
        <div className="review-controls-overlay" style={{
          position: "absolute",
          bottom: "20px",
          left: "50%",
          ...
          <button 
            ...
            style={{ width: "36px", height: "36px", padding: 0, minWidth: "unset", display: "flex", justifyContent: "center", alignItems: "center" }}
          >
          ...
          <span style={{ fontSize: "16px", fontWeight: "bold", minWidth: "60px", textAlign: "center" }}>
            {currentReviewIndex + 1} / {history.length}
          </span>
          <button 
            className="action-button secondary-action-button"
            onClick={() => setCurrentReviewIndex(Math.min(history.length - 1, currentReviewIndex + 1))}
            disabled={currentReviewIndex === history.length - 1}
            style={{ width: "36px", height: "36px", padding: 0, minWidth: "unset", display: "flex", justifyContent: "center", alignItems: "center" }}
          >
          ...
          <div style={{ width: "2px", height: "24px", background: "rgba(255,255,255,0.2)", margin: "0 10px" }} />
