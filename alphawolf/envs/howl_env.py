...
class HowlEnv(gym.Env):
    ...
    def __init__(self, m: int, n: int):
        ...
        # Observation space: 2D array of the grid (1 = active vertex, 0 = removed)
        self.observation_space = spaces.Box(low=0, high=1, shape=(m, n), dtype=np.int8)
        
        # Action space: Flattened 1D discrete selection of a vertex
    ...
    def _get_obs(self):
        obs = np.zeros((self.m, self.n), dtype=np.int8)
